...
<pre style="position: relative;"><strong>Input:</strong> root = [1,2,3,4,-99,-99,7,8,9,-99,-99,12,13,-99,14], limit = 1
...
<pre style="position: relative;"><strong>Input:</strong> root = [5,4,8,11,null,17,4,7,1,null,null,5,3], limit = 22
...
<pre style="position: relative;"><strong>Input:</strong> root = [1,2,-3,-5,null,4,null], limit = -1
